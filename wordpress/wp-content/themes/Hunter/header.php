...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div class="search-box">
			<div class="pull-handle"> <i class="fa fa-search"></i> </div>
			<?php get_search_form(); ?>
		</div>

		<div class="container"> <div class="row"> 
			<div class="col-md-12"><div class="siteheader">
	...
	<?php } ?>
				...
				<?php if(is_home()):?>
						<div class="show-down"> <i class="fa fa-sort-desc"></i> </div>
				<?php endif ?>
	...
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<div class="container"> <div class="row"> 
			<div class="col-md-12">
				<?php wp_nav_menu( array( 'theme_location' => 'primary' ,'menu_id' =>'hunter') ); ?>
			</div>
		</div></div>
	</nav><!-- #site-navigation -->
