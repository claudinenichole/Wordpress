...
function fabthemes_setup() {
	...
	add_theme_support( 'post-formats', array(
		'aside', 'image', 'video', 'quote', 'link', 'audio', 'gallery', 'chat', 'status'
	) );
...
function fabthemes_scripts() {
	...
	wp_enqueue_script( 'imagesloaded', get_template_directory_uri() . '/js/imagesloaded.pkgd.js', array(), '20120206', true );
	wp_enqueue_script( 'masonry', get_template_directory_uri() . '/js/masonry.js', array(), '20120206', true );
...
function home_class_name( $classes ) {
	if(is_home() && !is_paged()) { 
		$classes[] = 'home-page';
		return $classes; 
	} else {
...
add_filter( 'body_class', 'home_class_name' );
